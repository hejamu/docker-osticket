...
ENV OSTICKET_VERSION=1.15 \
    OSTICKET_SHA256SUM=b226809b7ad5d8dc25b248d6e929827c9b28010e3807968f7609e0c23188eda6
RUN set -ex; \
    \
...
STOPSIGNAL SIGTERM
EXPOSE 80
HEALTHCHECK CMD curl -fIsS https://www.physcip.uni-stuttgart.de/osticket || exit 1
